...
interface IAccessibleViewService { readonly _serviceBrand: undefined; show(..._args: any[]): void; }
class NullAccessibleViewService implements IAccessibleViewService { declare readonly _serviceBrand: undefined; show() {} }
...
const INotebookEditorModelResolverService = createDecorator<INotebookEditorModelResolverService>('notebookEditorModelResolverService');
interface INotebookEditorModelResolverService { readonly _serviceBrand: undefined; }
class NullNotebookEditorModelResolverService implements INotebookEditorModelResolverService { declare readonly _serviceBrand: undefined; }
...
interface INotebookEditorService { readonly _serviceBrand: undefined; }
class NullNotebookEditorService implements INotebookEditorService { declare readonly _serviceBrand: undefined; }
...
interface INotebookKernelService { readonly _serviceBrand: undefined; }
class NullNotebookKernelService implements INotebookKernelService { declare readonly _serviceBrand: undefined; }
registerSingleton(INotebookKernelService, NullNotebookKernelService, InstantiationType.Delayed);

// --- INotebookExecutionStateService ---
const INotebookExecutionStateService = createDecorator<INotebookExecutionStateService>('INotebookExecutionStateService');
interface INotebookExecutionStateService { readonly _serviceBrand: undefined; }
class NullNotebookExecutionStateService implements INotebookExecutionStateService { declare readonly _serviceBrand: undefined; }
...
const INotebookRendererMessagingService = createDecorator<INotebookRendererMessagingService>('INotebookRendererMessagingService');
interface INotebookRendererMessagingService { readonly _serviceBrand: undefined; }
class NullNotebookRendererMessagingService implements INotebookRendererMessagingService { declare readonly _serviceBrand: undefined; }
...
interface INotebookCellStatusBarService { readonly _serviceBrand: undefined; }
class NullNotebookCellStatusBarService implements INotebookCellStatusBarService { declare readonly _serviceBrand: undefined; }
